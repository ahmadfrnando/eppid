...
<div>
    <div class="relative overflow-x-auto sm:rounded-lg">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col-1" class="px-6 py-3">
                            Nama
                        </th>
                        <th scope="col" class="px-6 py-3 hidden md:table-cell">
                ...
                @foreach ($perminfos as $perminfo)
                    <tbody>
                        <tr
                            ...
                            <td class="px-6 py-4 hidden md:table-cell">
                                <span
                                    class=" text-xs  font-medium me-2 px-2.5 py-0.5 rounded-full {{ $perminfo->status == 'DITOLAK' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' : 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900 dark:text-cyan-300' }}">{{ $perminfo->status }}</span>
                            </td>
                            <td class="px-6 py-4 w-50" x-data="{ open: false }">
                                <div class="flex">
                                    <a href="public/storage/{{ $perminfo->buktipengajuan }}" target="_blank">
                                        <span
        ...
        <nav class="flex items-end flex-column flex-wrap md:flex-row justify-between pt-4">
